...
CREATE TABLE `film` (
  ...
  `opisFilm` varchar(70) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `radno_mjesto` (
  ...
  `opisRadnoMjesto` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`idRadnoMjesto`),
  UNIQUE KEY `nazivRadnoMjesto_UNIQUE` (`nazivRadnoMjesto`)
...
CREATE TABLE `sala` (
  ...
  PRIMARY KEY (`idSala`),
  UNIQUE KEY `nazivSala_UNIQUE` (`nazivSala`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `status_film` (
  ...
  UNIQUE KEY `nazivStatusFilm_UNIQUE` (`nazivStatusFilm`)
...
CREATE TABLE `status_karta` (
  ...
  UNIQUE KEY `NazivStatusKarta_UNIQUE` (`NazivStatusKarta`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `zaposleni` (
  ...
  `telefon` char(64) COLLATE utf8_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2016-01-18 11:40:55
