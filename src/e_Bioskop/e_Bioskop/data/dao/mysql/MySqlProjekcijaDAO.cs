...
namespace e_Bioskop.data.dao.mysql
{
    ...
    {
        private string getAllQuerry = "SELECT idProjekcija,vrijemeProjekcija,idFilm,cijenaProjekcija,p.idSala,aktivna,nazivSala from projekcija p inner join sala s on p.idSala=s.idSala;";
        private string getByFilmQuerry = "SELECT idProjekcija,vrijemeProjekcija,idFilm,cijenaProjekcija,p.idSala,aktivna,nazivSala from projekcija p inner join sala s on p.idSala=s.idSala where idFilm=?idFilm;";
